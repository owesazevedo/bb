    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Register a composition with machineProviderId and environmentProviderId instead of lifecycle callbacks; core creates the machine and uses the concrete environment provider, preserving its checkout ownership",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Implement reconcileCleanup to discover and remove uncertain allocations by durable key or metadata, never create or bootstrap; return failed while allocation intent is unresolved so core retries on its cleanup interval",
          "Checkpoint a recoverable resource during suspend before destructive cleanup",
          ...
          "Read the current persisted machine resource by host ID with bb.experimental_machines.experimental_getResource; reads work across plugins and return null for absent hosts or resources",
        ...
        apiSymbols: [
          "PluginMachines",
          "PluginMachines.experimental_getResource",
          "EnrollmentBootstrap",
          "MachineEnrollment",
          ...
          "PluginMachineProviderResumeContext",
